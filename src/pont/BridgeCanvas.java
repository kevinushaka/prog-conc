...
class BridgeCanvas extends Canvas {
    ...
    BridgeCanvas(SingleLaneBridge controller) {
        ...
        Path imgPath = Paths.get("image/redcar.gif");
        if (Files.exists(imgPath)) {
        	redCar = Toolkit.getDefaultToolkit().getImage("image/redcar.gif");
        	blueCar = Toolkit.getDefaultToolkit().getImage("image/bluecar.gif");
        	bridge = Toolkit.getDefaultToolkit().getImage("image/bridge.gif");
        } else {
